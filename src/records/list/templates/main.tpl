...
<ul class="table-view core no-top">
  <li class="table-view-cell">
      ...
      <label class="pull-left " style="margin: 0px; padding: 0px;">
        <input id="nyph-list-place" required class="validationsubject" type="text" placeholder="Where did you go?" name="nyph-list-place" value="<%= obj.nyphListPlacename %>" style="margin: 0px; padding: 0px;text-align: left; border: none; height: inherit; font-size: inherit;">
  ...
  <li class="table-view-cell">
    ...
    <label class="pull-left " style="margin: 0px; padding: 0px;">
      <input id="nyph-list-recorders" required class="validationsubject" type="text" placeholder="Who went?" name="nyph-list-recorders" value="<%= obj.nyphListRecorders %>" style="margin: 0px; padding: 0px;text-align: left; border: none; height: inherit; font-size: inherit;">
  ...
  <li class="table-view-cell">
      ...
      <label class="pull-left " style="margin: 0px; padding: 0px;">
        <input id="nyph-list-email" type="email" class="validationsubject" placeholder="Email address (optional)" name="nyph-list-email" value="<%= obj.nyphListEmail %>" style="margin: 0px; padding: 0px;text-align: left; border: none; height: inherit; font-size: inherit;">
